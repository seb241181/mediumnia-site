 ...
 * jamais dépasser 597 € (prix de la Formation complète). En production, fermé tant que
...
export const PATH_TERMS_VERSION = 'formation-parcours-2026-10-01-v2'
...
export async function settlePathAfterFullPurchase(supabase, env, userId) {
  if (!pathEnv() || !userId) return { skipped: true }
  try {
