...
function verifiedPayment(cfg, data, { requireConsent = false } = {}) {
  ...
  // Le consentement est imposé côté serveur AVANT la création de la commande.
  // PayPal ne garantit pas que custom_id soit renvoyé dans toutes les réponses de capture,
  // donc on ne fait pas dépendre le provisionnement de son écho dans la réponse de capture.
