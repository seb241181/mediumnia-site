...
async function sendConfirmation(supabase: any, firstName: string, email: string, registrationId: string, event: any, liveAccessToken?: string | null, appBaseUrl = "https://mediumia.fr") {
  ...
  const raffleText = `\n🎁 Pendant le direct, 1 accès complet à la formation MediumIA (valeur 397 € TTC) sera offert par tirage au sort parmi les participants présents ayant validé leur participation au tirage. Participation gratuite, sans obligation d’achat.\n`;
  ...
  const raffleBlock = `<div style="margin:26px 0;padding:20px;border:1px solid #c9a84c;background:#fbf7ea;border-radius:10px;color:#1a1535"><p style="margin:0 0 7px;font-size:12px;letter-spacing:1.2px;color:#9a7b2f"><strong>TIRAGE AU SORT EN DIRECT</strong></p><p style="margin:0"><strong>1 formation MediumIA complète offerte — valeur 397 € TTC.</strong></p><p style="margin:8px 0 0;font-size:13px;color:#706a80">Participation gratuite, sans obligation d’achat, réservée aux participants présents en direct ayant validé leur participation au tirage.</p></div>`;
