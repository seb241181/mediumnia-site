...
const ROUTE_IMAGES = {
  conferences: { src: '/images/conference/conference-22-octobre-partage-397.jpg', width: 1200, height: 630, alt: 'Conférence offerte MediumIA le jeudi 22 octobre à 19 h avec Sébastien Seguin' },
