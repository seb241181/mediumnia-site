    ...
    <section className="px-4 md:px-6 pb-24 max-w-5xl mx-auto">
      ...
      <div className="rounded-3xl overflow-hidden border border-gold/25 shadow-xl bg-white/55 min-h-[650px] flex flex-col">
        ...
        <div className="flex-1 px-4 md:px-8 py-7 space-y-4 overflow-y-auto max-h-[520px]">
          {messages.length === 0 && (
            <div className="max-w-xl mx-auto text-center py-16">
              ...
              <p className="font-georgia text-mist leading-relaxed">Commencez naturellement. Il connaît déjà la mission, le ton, les connaissances et les limites que vous lui avez définis.</p>
            </div>
          )}
        ...
        <form onSubmit={sendMessage} className="border-t border-gold/15 p-4 md:p-6 bg-cream/80">
          ...
          <p className="font-georgia text-[11px] text-mist/55 mt-3">Conversation enregistrée dans votre espace MediumIA. Les actions externes restent désactivées.</p>
        </form>
      </div>
    </section>
  )
