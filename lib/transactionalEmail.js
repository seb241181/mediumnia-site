...
/**
 * Envoie ou programme un email via l'API Resend.
 *
 * @param {object} opts
 ...
 * @param {string}  [opts.scheduledAt]  Date ISO 8601 pour un envoi programmé
 *
 * @returns {Promise<{status: 'sent'|'error'|'not_configured', id?: string, httpStatus?: number}>}
 */
 ...
 * Une annulation répétée ou trop tardive peut renvoyer une erreur Resend ;
 * l'appelant décide alors s'il doit considérer l'annulation comme en attente.
 */
