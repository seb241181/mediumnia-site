...
const routes = [
  ...
  '/conferences', '/reseau', '/reseau/rejoindre', '/pro', '/mentions', '/confidentialite', '/cgv-oracle', '/cgv-chronosphere', '/retractation', '/avis', '/avis/moderation', '/defi-intuition', '/formation/parcours', '/cartes-cadeaux',
