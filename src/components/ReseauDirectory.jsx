        ...
        <section className="px-6 pb-20 max-w-6xl mx-auto">
          ...
          <div className="max-w-xl mx-auto text-center mt-14 rounded-3xl border border-gold/20 px-8 py-8 bg-white/30">
            ...
            <p className="font-georgia text-mist leading-relaxed">
              Amandine, Lydie, Willy, Clara, Stéphanie, Gilda, Blandine et Ophélie font partie des premiers profils du Réseau MediumIA. D'autres professionnels sélectionnés viendront progressivement enrichir l'annuaire.
            </p>
          </div>
        </section>
      </main>
