...
test('ecosystem pathways stay contextual and non-coercive', async () => {
  ...
  assert.match(component, /Essayer gratuitement/)
  assert.match(component, /Être éclairé/)
  assert.match(component, /Parler à quelqu’un/)
  assert.match(component, /Apprendre/)
