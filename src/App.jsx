...
const INCLUS = [
  { icon: '📚', titre: '25 modules PDF · 269 pages', texte: "Accès envoyé par email dans les heures qui suivent votre achat. 25 modules complets répartis en 4 niveaux, plus une introduction et un lexique. Écrits dans un langage clair, profond et accessible. Chaque module contient des explications, des exercices pratiques, des questions de réflexion et une citation centrale." },
      ...
      <Section>
        ...
        <div className="border-2 border-gold/40 rounded-2xl p-8 md:p-12 bg-white/70 text-center">
          ...
          <p className="font-georgia text-xs text-mist mt-6 leading-relaxed max-w-md mx-auto">
            Paiement sécurisé par PayPal. Votre code d'accès et le lien vers vos modules vous sont envoyés par email dans les heures qui suivent le paiement (sous 3h maximum).
          </p>
        </div>
      </Section>
    </section>
...
const FAQ_ITEMS = [
  ...
  { q: "Puis-je suivre ce parcours depuis l'étranger ?", r: "Oui. L'application Mediumia, le coach IA et les modules PDF sont accessibles partout dans le monde, 24h/24, sans frais d'expédition. Dès votre paiement validé, vous téléchargez vos modules directement depuis votre espace personnel, où que vous soyez." },
