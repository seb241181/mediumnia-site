...
<p style="text-align:center;margin:28px 0"><a href="${GAME_URL}" style="display:inline-block;background:#1a1535;color:#e4c77a;text-decoration:none;padding:14px 26px;border-radius:8px;font-weight:bold">Jouer au défi du jour</a></p>
...
export function buildReminderEmail(unsubscribeUrl, welcome = false) {
  ...
  const intro = welcome
    ? 'C’est noté : chaque matin, un petit e-mail vous rappellera votre défi du jour. Trois cartes à trouver, une minute de jeu.'
