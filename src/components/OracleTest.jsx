  ...
  return (
    <section className="px-6 py-20 md:py-28 max-w-3xl mx-auto w-full">
      ...
      <h2 className="font-georgia text-2xl md:text-3xl text-deep font-medium leading-tight mb-4">
        Tirage test de l'Oracle ✦
      </h2>
      <p className="font-georgia text-mist text-base md:text-lg italic mb-10">
        Choisissez trois numéros entre 0 et 44. Lumia vous offrira une interprétation unique, envoyée par email. Un seul tirage par adresse.
      </p>
      <div className="border border-gold/20 rounded-2xl p-8 bg-white/60">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input id="oracle-email" type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="votre@email.com"
